...
public interface BoardRepository {
	...
	public List<BoardResponse> listinfo(@Param("startPage") long startPage, @Param("type") long type, @Param("itemsperpage") long itemsperpage, @Param("searchselect") String searchselect, @Param("searchtxt") String searchtxt, @Param("userId") long userId) throws Exception;
