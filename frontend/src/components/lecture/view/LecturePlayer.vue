        ...
        <v-expand-x-transition>
            <v-card :width="listWidth" v-show="list" ref="list" tile flat style="z-index:100; position:fixed; width:400px; top:0px; height:100%;" :style="{'right':navWidth+'px'}">
                <v-tabs v-model="tabs" hide-slider height=0>
                    <v-tab-item>
                        ...
                        <v-list ref="contents" style="overflow-y:scroll; font-size:14px" :style="{'height':contentHeight+'px'}" :dark="darkOption">
                            <v-list-item 
            ...
            <div style="position:absolute; top:0px; left:0px; width:100%; height:100%; z-index:10; ">            
                    <div :style="{'width' : videoWidth+'px'}">
                        ...
                        <v-layout style="position:fixed; z-index:99; bottom:20px; left: 20px;">                            
                            <v-btn color="error darken-1" @click="move(`/lecture/detail/${$route.params.id}`)">
                                <v-icon>mdi-exit-to-app mdi-rotate-180</v-icon>               
                            </v-btn>
                        </v-layout>                
