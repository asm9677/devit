...
<div>
    <layout wrap ref="main">
                ...
                <v-tooltip left color="primary" open-on-hover open-on-focus open-on-click>
                    <template v-slot:activator="{ on, attrs }">
                        <v-list-item 
                            ...
                            v-on="on" 
                            link 
                            @click="menu == 0 ? closeList() : openList(); tabs=0"
                        >
                            <v-list-item-icon>
        ...
        <v-expand-x-transition>
            <v-card :width="listWidth" v-show="list" ref="list" tile flat outlined style="z-index:100; position:fixed; width:300px; top:0px;" :style="{'right':navWidth+'px'}">
            ...
            <div style="position:absolute; top:0px; left:0px; width:100%; height:100%; z-index:10; background-color:white;">            
                    <div :style="{'width' : videoWidth+'px'}">
                        ...
                        <v-layout style="position:fixed; z-index:99; bottom:20px;" :style="{'right': navWidth + listWidth + 10 + 'px'}">                            
                            <v-btn color="primary lighten-1" style="margin-right:30px;">
                                <v-icon left>mdi-chevron-left</v-icon>
                                이전                                
                            </v-btn>
                            <v-btn color="primary lighten-1" style="margin-right:20px;">
                                다음
                        ...
                        <v-list>
                            <v-list-item>
                                ...
                                <v-list-item-action>
                                    <v-btn small class="mx-2" fab light color="white"  :loading="btnLoading">
